...
|----------|----------|---------------|
| Strictly Necessary | @supabase/supabase-js, stripe | Always active (no toggle) |
...
*This guide was auto-generated by Codepliant based on code analysis of acme-saas. It provides implementation guidance only and does not constitute legal advice. Consult with a qualified privacy professional for your specific compliance requirements.*