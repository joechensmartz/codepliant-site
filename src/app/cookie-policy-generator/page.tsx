...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.codepliant.site/cookie-policy-generator",
  },
  openGraph: {
    title: "Cookie Policy Generator for Developers",
    description:
      "Cookie policy generator that scans your code to detect tracking scripts, analytics SDKs, and session cookies. GDPR and ePrivacy compliant. Free CLI.",
    url: "https://www.codepliant.site/cookie-policy-generator",
  ...
  return {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://www.codepliant.site/cookie-policy-generator",
      },
    ],
  };
}
