...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.codepliant.site/terms-of-service-generator",
  },
  openGraph: {
    title: "Terms of Service Generator for SaaS",
    description:
      "Terms of service generator for SaaS apps. Scans your code to detect payments, auth, and AI, then generates ToS with liability and IP clauses. Free CLI.",
    url: "https://www.codepliant.site/terms-of-service-generator",
  ...
  return {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://www.codepliant.site/terms-of-service-generator",
      },
    ],
  };
}
