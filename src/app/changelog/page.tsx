...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.codepliant.site/changelog",
  },
  openGraph: {
    ...
    url: "https://www.codepliant.site/changelog",
...
const releases: Release[] = [
  {
    ...
    changes: [
      ...
      {
        category: "tests",
        text: "Test suite expanded from 763 to 6,711 tests (780% increase) with 100% scanner coverage and 132 generator test suites (95.7% of 138 generators)",
      },
    ],
  },
  {
  ...
  return {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Changelog",
        item: "https://www.codepliant.site/changelog",
      },
    ],
  };
}
