...
> This Data Processing Agreement ("DPA") is entered into pursuant to Article 28 of the General Data Protection Regulation (EU) 2016/679 ("GDPR"). It governs the processing of personal data by third-party processors on behalf of the Controller in connection with the **codepliant** application.
...
- **Contact Information:** email addresses detected in TypeORM/Sequelize model fields: User.email. email addresses, phone numbers detected in Mongoose model fields: UnknownModel.email, UnknownModel.phone. email addresses detected in Drizzle ORM table fields: users.email.
- **API Data Collection:** 3 API endpoint(s) accepting user data via POST, PUT requests. Data fields collected: email, name.
