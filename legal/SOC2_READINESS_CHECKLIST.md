...
| CarrierWave | File Storage | Confidentiality (C1), Security (CC6) |
...
| UploadThing | File Storage | Confidentiality (C1), Security (CC6) |
...
- [ ] Enable server-side encryption for: Active Storage, CarrierWave, UploadThing
