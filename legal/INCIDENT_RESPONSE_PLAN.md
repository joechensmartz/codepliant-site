...
This project handles Protected Health Information (PHI). The HIPAA Breach Notification Rule (45 CFR §§ 164.400–414) imposes specific notification requirements.

### HIPAA Notification Timelines

| Recipient | Deadline | Requirement |
| --------- | -------- | ----------- |
| **Affected individuals** | Within 60 days of discovery | Written notice by first-class mail or email (if consented) |
| **HHS Secretary** | Within 60 days (≥ 500 individuals) or annually (< 500) | Via HHS breach reporting portal |
| **Prominent media outlets** | Within 60 days (≥ 500 individuals in a state/jurisdiction) | Press release or equivalent |

### HIPAA Breach Assessment

Determine whether an impermissible use or disclosure of PHI constitutes a breach by evaluating:

1. **Nature and extent of PHI involved** — types of identifiers and likelihood of re-identification
2. **Unauthorized person** — who impermissibly used or received the PHI
3. **Acquisition or viewing** — whether PHI was actually acquired or viewed
4. **Mitigation** — extent to which risk has been mitigated

Unless you demonstrate through a risk assessment that there is a **low probability** that PHI has been compromised, a breach is presumed and notification is required.
...
*This incident response plan was generated by [Codepliant](https://github.com/codepliant/codepliant) based on an automated scan of the **codepliant** codebase. It should be reviewed and customized by your legal and security teams before adoption.*
